    ...
    <main>
        ...
        <div class="contents-wrapper">
            <section class="login_box">
                <h3>会員登録がお済みのお客様</h3>
                <p class="explain">会員の方は、ユーザネームとパスワードでログインしてください。</p>
           ...
           <section class="register_box">
               <h3>まだ会員登録をされていない方</h3>
               <p class="explain">商品のご購入のためには会員登録が必要です。</p>
               <a href="register.php" class="btn register">会員登録をする</a>
           </section>
       </div>
    </main>
    <footer>
